...
names = ['Riany', 'Bruno', 'Pedro', 'Diogo']  # Lista original
target_name = "Bruno"  # Agora apenas Bruno será reconhecido
...
last_position_x = {}
middle_line_x = 320  # Linha central da tela
...
while True:
    ...
    cv2.line(img, (middle_line_x, 0), (middle_line_x, 480), (0, 0, 255), 2)  # Linha vermelha no meio
    ...
    for (x, y, w, h) in faces:
        ...
        # Garantindo que apenas Bruno seja reconhecido
        if confidence_value >= 55 and names[id] == target_name:
            id = names[id]
        else:
            id = "Bruno"
        ...
        if id == target_name:
            ...
            cv2.line(img, (last_position_x[id], y + h // 2), (center_x, y + h // 2), (0, 255, 0), 2)  # Linha verde de movimento

            if center_x > middle_line_x and last_position_x[id] < middle_line_x and recognized_last_time[id] != id:
                log_recognition("entrou", id, confidence_value)
                recognized_last_time[id] = id
            elif center_x < middle_line_x and last_position_x[id] > middle_line_x and recognized_last_time[id] == id:
