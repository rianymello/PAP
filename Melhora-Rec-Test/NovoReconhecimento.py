...
import dlib  # Importa a biblioteca dlib
...
# Inicializando o detector facial CNN do dlib, que usa GPU, se disponível
...
def process_faces():
    ...
    while running:
        if frame_to_process is not None:
            ...
            # Detectar rostos com o modelo CNN do dlib (utiliza GPU, se disponível)
            face_locations = cnn_face_detector(rgb_frame, 1)  # O parâmetro '1' indica que o dlib deve usar multi-threading

            recognized_faces = []
            for face in face_locations:
                # Extrair a posição do rosto e calcular o encoding
                ...
                # Garantir que o face_encoding não esteja vazio
                if face_encoding:
