...
TRAINING_PATH = 'data/fotos'  # Nova pasta onde as fotos de treinamento estão armazenadas
MODEL_PATH = 'models/trainer.yml'  # Novo local para salvar o modelo treinado

# Inicializando o reconhecedor LBPH e o detector de faces
recognizer = cv2.face.LBPHFaceRecognizer_create()
detector = cv2.CascadeClassifier('haarcascades/haarcascade_frontalface_default.xml')  # Caminho atualizado para o Haar Cascade
...
recognizer.write(MODEL_PATH)  # Salva o modelo treinado no local atualizado
